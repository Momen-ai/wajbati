            ...
            <div class="col-lg-6">
                <div class="ps-lg-3">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        <span class="badge bg-light text-dark border ms-0">{{ $meal->category->name ?? 'General' }}</span>
                    </div>

                    <!-- Chef Info -->
                    <div class="card bg-light border-0 p-3 mb-4 rounded-3 d-flex flex-row align-items-center">
                    ...
                    <!-- Add to Cart Box -->
                    <div class="card shadow-card p-4 border-0">
                        <h5 class="fw-bold mb-3">Order Now</h5>
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="quantity" value="1" min="1"
                                            class="form-control text-center border-secondary" style="max-width:80px">
                                        <button class="btn btn-outline-secondary" type="button"
                ...
                <div class="mb-5">
                    <h4 class="fw-bold mb-4">Reviews ({{ $meal->ratings_count ?? $meal->ratings->count() }})</h4>
                    ...
                    <div class="reviews-list">
                        @forelse($meal->ratings as $rating)
                            <div class="d-flex mb-4 border-bottom pb-4">
                                <div class="bg-light rounded-circle flex-shrink-0 d-flex align-items-center justify-content-center me-3"
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 text-muted">{{ $rating->body }}</p>
                                </div>
                            </div>
                        @empty
                    ...
                    <div class="col-md-3">
                        <div class="card shadow-card border-0 h-100 meal-card">
                            ...
                            <div class="card-body p-3">
                                <h6 class="fw-bold mb-1 text-truncate">{{ $related->name }}</h6>
