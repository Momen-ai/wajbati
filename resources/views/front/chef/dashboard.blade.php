...
<div class="container py-5">
    <div class="row mb-4">
        <div class="col-12">
            ...
            <p class="text-muted">Here's what's happening with your kitchen today.</p>
        </div>
    </div>
    ...
    <div class="row g-4 mb-5">
        <div class="col-md-3">
            <div class="card shadow-card border-0 rounded-4 p-3 text-center hover-lift">
                ...
                <h3 class="fw-bold mb-0">{{ $totalMeals }}</h3>
    ...
    <div class="row g-4">
        <!-- Recent Orders -->
        <div class="col-lg-8">
            <div class="card shadow-card border-0 rounded-4 h-100">
                <div class="card-header bg-white border-0 pt-4 px-4 d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold mb-0">Recent Orders</h5>
                    <a href="{{ route('chef.orders.index') }}" class="btn btn-sm btn-light rounded-pill">View All</a>
                </div>
        ...
        <div class="col-lg-4">
            <div class="card shadow-card border-0 rounded-4 mb-4">
                <div class="card-body p-4 text-center">
                    ...
                    <h5 class="fw-bold">Growing your menu?</h5>
                    <p class="text-muted small">Add your latest delicious creations to attract more customers.</p>
                    <a href="{{ route('chef.meals.create') }}" class="btn btn-primary w-100 rounded-pill shadow-sm">Add New Meal</a>
                </div>
            </div>
            
            <div class="card shadow-card border-0 rounded-4">
                <div class="card-body p-4">
                    <h5 class="fw-bold mb-3">Kitchen Profile</h5>
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            <div class="fw-bold text-truncate" style="max-width: 150px;">{{ Auth::user()->kitchen_name ?? 'My Kitchen' }}</div>
                            <small class="text-muted">Chef Account</small>
                        </div>
                    </div>
                    <a href="{{ route('profile.edit') }}" class="btn btn-outline-secondary w-100 rounded-pill btn-sm">Edit Profile</a>
                </div>
            </div>
        </div>
    </div>
